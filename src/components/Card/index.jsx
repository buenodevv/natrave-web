...
export const Card = ({disabled,gameId,homeTeam, awayTeam, gameTime, awayTeamScore, homeTeamScore }) => {
    ...
    return (
        <div className=" rounded-xl border border-grey-300 p-4 text-center space-y-4">
            ...
            <form className="flex space-x-4 justify-center items-center">
                ...
                <input 
                    type="number" 
                    className="bg-red-300/[0.2] w-[55px] h-[55px] text-red-700 text-xl text-xl text-center" 
                    name="homeTeamScore" 
